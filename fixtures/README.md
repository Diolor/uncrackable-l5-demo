...
| File | Device | Result |
| --- | --- | --- |
| `oneplus9pro-android14-tee-tier2.json` | OnePlus 9 Pro (LE2123), Android 14, locked bootloader, verified boot green, no StrongBox; debug build `org.owasp.mastg.uncrackable5.debug` signed with a developer debug key | Accepted, tier 2 |
